...
//      COMPLETED (7) Generate a weather summary with the date, description, high and low
        ...
        int id = mCursor.getInt(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID));
        ...
        String formatedHighLowTemp = SunshineWeatherUtils.formatHighLows(mContext, maxTemp, minTemp);

        String weatherSummary = dateString + " - " + description + " - " + formatedHighLowTemp;
