...
//      COMPLETED (31) Display the wind speed and direction
        ...
        String windFormatedString = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDirection);
        mWindTextView.setText(windFormatedString);
...
//      COMPLETED (33) Store a forecast summary in mForecastSummary
        mForecastSummary = String.format("%s - %s - %s/%s", dateString, description, highTempString, lowTempString);
    }
